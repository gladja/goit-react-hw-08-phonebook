...
import { deleteContacts, getAllContacts, updateContacts } from '../../redux/contacts/operations';
...
export const ContactList = () => {
  ...
  //   // dispatch(updateContacts( id, name, number));
  // };
        ...
        <Box sx={{ width: 400, px: 4 }}>
          <List>
            ...
            {contactsFilterResult && !isLoading && contactsFilterResult.map(({ id, name, number }) => (
              <>
                <ContactOne id={id} name={name} number={number}/>
